...
abc::Aig_Man_t *                                    Ckt_WinConstructAppAig          (abc::Mfs_Man_t * p, abc::Abc_Obj_t * pNode, abc::Vec_Ptr_t * vWinPIs);
abc::Aig_Obj_t *                                    Ckt_WinConstructAppAig_rec      (abc::Mfs_Man_t * p, abc::Abc_Obj_t * pNode, abc::Aig_Man_t * pMan, abc::Vec_Ptr_t * vWinPIs);
