...
abc::Aig_Obj_t *                                    Ckt_WinConstructAppAig2_rec     (abc::Mfs_Man_t * p, abc::Abc_Obj_t * pNode, abc::Aig_Man_t * pMan, abc::Vec_Ptr_t * vWinPIs, std::shared_ptr <Ckt_Ntk_t> pCktNtk);
